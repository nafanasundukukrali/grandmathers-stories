...
function checking_tests_with_prefix {
   ...
   while [ -f ../data/"$1"_"$enter_number"_in.txt ]; do
	   ...
	   if ! [ -f ../data/"$1"_"$enter_number"_args.txt ]; then
		./pos_case.sh ../data/"$1"_"$enter_number"_in.txt ../data/"$1"_"$enter_number"_out.txt > /dev/null
	   else
		./pos_case.sh ../data/"$1"_"$enter_number"_in.txt ../data/"$1"_"$enter_number"_out.txt ../data/"$1"_"$enter_number"_args.txt > /dev/null
	   fi
	   ...
	   if ! [ -f ../data/"$1"_"$enter_number"_args.txt ]; then
               ...
               ./neg_case.sh ../data/"$1"_"$enter_number"_in.txt ../data/"$1"_"$enter_number"_args.txt > /dev/null
           fi	
